...
function onCreate()
	...
	makeLuaSprite('light','BG/green/light', -1750, 100)
...
scaleObject('light', 2.1, 2.1);
	...
	addAnimationByPrefix('shiro','loop','stand', 24, true)

scaleObject('shiro', 2, 2);

	
	makeAnimatedLuaSprite('powers','BG/green/powers', -1280, 750)
	addAnimationByPrefix('powers','doot','doot 1', 24, false)
	scaleObject('powers', 3.2, 3.2);
	setProperty('powers.alpha', 0);
